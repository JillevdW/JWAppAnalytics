#
#  Be sure to run `pod spec lint JWAppAnalytics.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = "Jille van der Weerd"
  # Or just: spec.author    = "Jille"
  # spec.social_media_url   = "https://twitter.com/JillevdW"
  ...
  spec.source_files = "JWAppAnalytics"
